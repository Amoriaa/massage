...
омолаживающий эффект.</p>
    ...
    <a href={'/contacts'}><button className="button1"><b className="b1">Связаться</b></button></a>
    <a href={'/about'}><button className="button2"><b className="b2">Узнать подробнее</b></button></a>
      </div>
